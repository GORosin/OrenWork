...
class TestingKernel {
    ...
    private final Game testGameStart;
    private final Turn testTurn;


    // The board that we will use to check the state of the pieces with.
    private Board  testBoard;

    private final String playerOne = "Joe";
    private final String playerTwo = "Bob";
     ...
     *
     * param aFacade The buttonHandler to manipulate in this program.
     */
    private TestingKernel(){
        //testButtonHandler = aFacade;
        testGameStart = new Game();
        testTurn = testGameStart.getTurn();
    ...
    private void setBegin(){
        ...
        try{
            testGameStart.setGameType(new GameLocal());
            // Create players
            // createPlayer(int num, int type)
            
            // Set the names for the players.
            testGameStart.createPlayer(playerOne, playerTwo );
    ...
    private void beginTests(){
        ...
        // Player One's Name
        passedTest = playerOne.equals( testGameStart.getPlayerOne() );
        report( passedTest, "Sets Player One name", 3 );
  
        // Player Two's Name
        passedTest = playerTwo.equals( testGameStart.getPlayerTwo());
    ...
    private boolean testBasicMoves(){
        ...
        testGameStart.getTurn().selectSpace( 19 );
        testGameStart.getTurn().selectSpace( 26 );
        ...
        testBoard = testGameStart.getTheBoard();
    ...
    private boolean testBounds(){
        ...
        testTurn.selectSpace( 46 );
        testTurn.selectSpace( 112 );
     ...
     * @return Whether or not it passed the test.
     */
    private boolean testForcedJump(){
        // Boolean for whether or not it passed the test.
        ...
        testTurn.selectSpace( 40 );
        testTurn.selectSpace( 33 );
               
        //Attempt to make a move which is not the forced jump.
        turn = testTurn.whosTurn();
        System.out.println( "Attempting move: 26 to 35" );
        testTurn.selectSpace( 26 );
        testTurn.selectSpace( 35 );
        ...
        if( turn != testTurn.whosTurn() ){ forceJumpTest = false; }
     ...
     * @return Whether or not it passed the test.
     */
    private boolean testInvalidMoves(){
        // Boolean for whether or not it passed the test.
        ...
        // the same starting and ending location.
        ...
        testTurn.selectSpace( 8 );
        testTurn.selectSpace( 17 );
        ...
        testTurn.selectSpace( 1 );
        testTurn.selectSpace( 19 );
        ...
        testTurn.selectSpace( 5 );
        testTurn.selectSpace( 37 );
        ...
        testGameStart.getTurn().selectSpace( 10 );
        testTurn.selectSpace( 19 );
     ...
     */
    private void report(boolean passFail, String name, int tabs){
